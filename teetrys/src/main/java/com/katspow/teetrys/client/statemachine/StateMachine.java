...
public class StateMachine {
	...
	public enum GameEvent {
		...
		CHOOSE_ABOUT, CHOOSE_GAME, CHOOSE_HIGHSCORES, CHOOSE_MAIN_MENU,

		CALL_PAUSE, CALL_DOWN, CALL_UP, CALL_LEFT, CALL_RIGHT, CALL_START, CALL_ROTATE, CALL_QUIT, CALL_CANCEL,
	...
	public enum GameState {
		...
		// MENUS will be the parent of these states : MAIN_MENU, HIGHSCORES,
		// ABOUT
		MENUS(null) {
		...
		// GAME will be the parent of these states : GAMING, PAUSE, GAME_OVER,
		// INTERMEZZO(S), END
		GAME(null) {
